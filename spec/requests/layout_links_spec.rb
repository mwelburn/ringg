...
describe "LayoutLinks" do
  ...
  it "should have a Home page at '/'" do
    get '/'
    response.should have_selector('title', :content => "Keep track of your ring sizes")
  end
 ...
 #   response.should have_selector('title', :content => "Contact")
  ...
  describe "when not signed in" do
    ...
    it "should have a login link" do
      visit root_path
      response.should have_selector("a", :href => new_user_session_path, :content => "Login")
    end
  ...
  describe "when signed in" do
    ...
    it "should have a logout link" do
      visit root_path
      response.should have_selector("a", :href => destroy_user_session_path, :content => "Logout")
    end
